...
description: "What changed in each release, what 0.2.0 breaks in a 0.1.x bot, and the checklist for moving across."
---

The current version is `0.4.0`. Check what you have with `npm ls @cloak-software/bot-sdk`.
