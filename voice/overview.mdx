...
- **No recorder, no file sink, no transcription helper.** Subscribing is in scope, and a room-scope session hands decrypted member audio out as PCM frames (see [Receiving audio](/voice/audio#receiving-audio)). What a bot does with decrypted member audio is your business and your users' consent problem.
